...
public class Blockbusters : MonoBehaviour {
    ...
    private string[,] question_and_answers =
    {
        ...
        { "HomeFront concerns a resistance movement fighting against which country?","North Korea"},
        { "What was the first World Of Warcraft expansion pack?","The Burning Crusade"},
        { "Which Wii action-adventure game shares its name with an album by The Stranglers?","No More Heroes"},
        ...
        { "Which actor plays Alex West in the 2001 Tomb Raider movie?","Daniel Craig"},
    };
/*
        Metal Slug
*/
